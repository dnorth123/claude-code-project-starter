...
cp -r .workspace/templates/project-starter/.claude .
cp -r .workspace/templates/project-starter/docs .
cp .workspace/templates/project-starter/.gitignore .
cp .workspace/templates/project-starter/ENHANCEMENT-SETUP.md .
cp .workspace/templates/project-starter/LICENSE .
cp .workspace/templates/project-starter/README-STRUCTURE.md .
cp .workspace/templates/project-starter/Setup.md .
...
# Clean up workspace-specific files
echo -e "${YELLOW}Cleaning up workspace files...${NC}"
rm -rf .workspace
rm -rf projects
rm -f sync-templates.sh
